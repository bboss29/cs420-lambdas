...
public class Tests {
  ...
  public void testInners(){
    ...
    Assert.assertTrue("Your Education object may not be initializing variables correctly. Check the specs.",ed.toString().contains("NEIU") & ed.school.equals("NEIU")); // TODO idk
  }
